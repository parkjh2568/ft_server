...
echo "GRANT ALL PRIVIEGES ON wordpress.* TO 'root'@'localhost' WITH GRANT OPTION;" | mysql -u root --skip-password
echo "update mysql.user set plugin='mysql_native_password' where uwer='root';" |mysql -u root --skip-password
